...
public class ProblemController {
	...
	public Result findAll(){
		return new Result(true,StatusCode.OK, StatusMessage.Success,problemService.findAll());
	}
	...
	public Result findById(@PathVariable String id){
		return new Result(true,StatusCode.OK,StatusMessage.Success,problemService.findById(id));
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  new Result(true,StatusCode.OK,StatusMessage.Success,  new PageResult<Problem>(pageList.getTotalElements(), pageList.getContent()) );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return new Result(true,StatusCode.OK,StatusMessage.Success,problemService.findSearch(searchMap));
    }
	...
	public Result findNewListByLabelId(@PathVariable String labelid,@PathVariable int page,@PathVariable int size ){
		...
		return new Result(true, StatusCode.OK, StatusMessage.Success,pageResult);
	}
